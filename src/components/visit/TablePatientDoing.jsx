...
export default function TablePatientDoing({
  ...
  return (
    <>
            ...
            {patSelected.patientNationalId && (
              <TableBody>
                ...
                <TableRow>
                  <TableCell colSpan={4}>
                    <div className="">
                      <p className="font-semibold text-teal-500 border-t-2">تاریخچه ویزیت های بیمار</p>
                    </div>
                  </TableCell>
                </TableRow>

                {listReception.filter((e) => e.statusId === 4).length > 0 &&
                  listReception
                      ...
                      <div>
                        <div className="flex justify-center">
                          ...
                          >
                            ...
                            />
                            <path
                              d="M30.9514 66.6124L69.1774 62.1481V111.535L30.9514 101.211V66.6124Z"
                              fill="#EDF2F6"
                            />
                            ...
                            />
                            <path
                              d="M50.5 94L44.7002 93.2133"
                              stroke="#4A6C90"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                            <path
                              d="M47 96.2L44.7002 95.8587"
                              stroke="#4A6C90"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                        ...
                        <p className="mt-2 text-center">تاریخچه ویزیت های بیمار خالی است</p>
                      </div>
                    </TableCell>
                  </TableRow>
                )}
      ...
      {!patSelected.patientNationalId && <div className="mt-4">لطفا ابتدا بیمار را انتخاب کنید</div>}
    </>
  );
}
