...
export default function TableManageInfo({ valTypeList, valTypeCategoryList, setIsLoading, flag, setFlag , query}) {
  ...
  useEffect(() => {
    if (valTypeList) {
      setIsLoading(true);
      axios
        .get(`${mainDomain}/api/BasicInfo/Item/GetListPaged`, {
          params: {
            typeId: valTypeList,
  ...
  }, [valTypeList, valTypeCategoryList, flag, numPages , query]);
          ...
          <TableBody>
            {listItem.map((item, i) => (
              <TableRow key={item.itemId}>
                ...
                <TableCell align="center">{item.medicalCategoryTitle}</TableCell>
