...
export default function BoxSelectDate({ dates, dateReserved, setIsLoading, doctor, setPageState, account , isLoading}) {
        ...
        <div className="w-full">
          <div className="sticky top-0 left-0 right-0 w-full bg-white mb-4 z-50">
            <h3 className="text-xl font-semibold">
              {dates.length !== 0 ? 'لطفا زمان مورد نظر خود را انتخاب کنید' : 'لطفا تاریخ ورود خود را انتخاب کنید'}
            </h3>
          </div>
